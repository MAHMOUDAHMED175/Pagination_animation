...
//               return CircularProgressIndicator(); // تم استبدال LoadingIndicator بـ CircularProgressIndicator
//             if (snapshot.hasError)
//               return Text(
//                 'Location Error: ${snapshot.error.toString()}',
//                 style: TextStyle(color: Colors.red),
//               ); // تم استبدال LocationErrorWidget بـ Text
//
